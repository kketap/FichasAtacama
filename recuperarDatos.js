document.addEventListener('DOMContentLoaded', function () { //recuperar datos de accionista en PEP
  document.getElementById('mostrarDatosAccionistas').addEventListener('click', function () {
    ...
    function crearPreguntaClientePEP(numeroAccionista) {  //funcion para pasar el codigo html
      ...
      divSi.innerHTML = '<label style="padding-right: 10px;">Si</label> <input name="preguntaAccionistaPEP' + numeroAccionista + '" class="form-check-input" type="radio" value="0">';

      const divNo = document.createElement('div');
      divNo.className = 'form-check form-check-inline';
      divNo.innerHTML = '<label style="padding-right: 10px;">No</label> <input name="preguntaAccionistaPEP' + numeroAccionista + '" class="form-check-input" type="radio" value="1">';
...
document.addEventListener('DOMContentLoaded', function () { //recuperar datos de benef en PEP
  document.getElementById('mostrarDatosBeneficiarios').addEventListener('click', function () {
    ...
    function crearPreguntaClientePEP(numeroBeneficiario) {
      ...
      const divSi = document.createElement('div');
      divSi.className = 'form-check form-check-inline';
      divSi.innerHTML = '<label style="padding-right: 10px;">Si</label> <input name="preguntaBenefPEP' + numeroBeneficiario + '" class="form-check-input" type="radio" value="0">';

      const divNo = document.createElement('div');
      divNo.className = 'form-check form-check-inline';
      divNo.innerHTML = '<label style="padding-right: 10px;">No</label> <input name="preguntaBenefPEP' + numeroBeneficiario + '" class="form-check-input" type="radio" value="1">';
...
document.addEventListener('DOMContentLoaded', function () { //recuperar accionistas en residencia fiscal
  document.getElementById('mostrarResidenciaAccio').addEventListener('click', function () {
    ...
    function crearPreguntaResidencia(numeroAccionista) {
      ...
      const divNo = document.createElement('div');
      divNo.className = 'form-check form-check-inline';
      divNo.innerHTML = '<label style="padding-right: 10px;">No</label> <input name="residenciaFiscalPregunta' + numeroAccionista + '" class="form-check-input" type="radio" value="1">' + '<br><br>';
    ...
    accionistas.forEach(function (accionista, index) {
      if (accionista.nombre && accionista.rut) {
        const datosAccionista = document.createElement('p');
        datosAccionista.innerHTML = 'Nombre Completo Accionista (' + (index + 1) + ') : ' + accionista.nombre + '<br> RUT Accionista (' + (index + 1) + ') :' + accionista.rut + '<br><br>';

        const rowdivResidencia = crearInputsResidencia(index + 1); // Aquí se corrige la llamada
        datosAccionista.appendChild(rowdivResidencia);
...
document.addEventListener('DOMContentLoaded', function () { //recuperar datos benef en residencia fiscal
